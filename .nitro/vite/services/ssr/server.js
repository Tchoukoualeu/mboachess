...
function deepEqual(a, b2, opts) {
  ...
  if (Array.isArray(a) && Array.isArray(b2)) {
    ...
    for (let i = 0, l2 = a.length; i < l2; i++) if (!deepEqual(a[i], b2[i], opts)) return false;
    return true;
  }
...
var H = B(2), J = B(3), Ee = B(1), Ie = B(0), ut = B(4), lt = B(5), ct = B(6), ft = B(7);
function dn(e) {
  switch (e) {
    case '"':
      return '\\"';
...
var L = "__SEROVAL_REFS__", le = "$R", Re = `self.${le}`;
function yn(e) {
...
async function Fr(e, r, t) {
  ...
  return C in t && (a.push(I(e.base, C)), s.push(je(tr(e.base), await N$1(e, r, Xe(t))))), v in t && (a.push(I(e.base, v)), s.push(Ye(nr(e.base), await N$1(e, r, er(t))))), P$1 in t && (a.push(I(e.base, P$1)), s.push($(t[P$1]))), R in t && (a.push(I(e.base, R)), s.push(t[R] ? H : J)), { k: a, v: s };
}
...
function pa(e, r) {
  let t = ae$1(e, r.i, q(e, r.f) + "()"), n = r.a.length;
  if (n) {
    let a = f(e, r.a[0]);
...
function $r(e, r, t) {
  ...
  return C in t && (a.push(I(e.base, C)), s.push(je(tr(e.base), E(e, r, Xe(t))))), v in t && (a.push(I(e.base, v)), s.push(Ye(nr(e.base), E(e, r, e.type === 1 ? re$1() : er(t))))), P$1 in t && (a.push(I(e.base, P$1)), s.push($(t[P$1]))), R in t && (a.push(I(e.base, R)), s.push(t[R] ? H : J)), { k: a, v: s };
}
...
function requireServer_node() {
  ...
  var l2, s;
  {
    l2 = requireReactDomServerLegacy_node_production();
    s = requireReactDomServer_node_production();
  }
  server_node.version = l2.version;
  server_node.renderToString = l2.renderToString;
  server_node.renderToStaticMarkup = l2.renderToStaticMarkup;
