      ...
      <section className="mt-8 grid gap-4 sm:mt-10 sm:grid-cols-2">
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/50">
          ...
          <p className="mt-2 text-sm leading-6 text-zinc-700 dark:text-zinc-300">
            ...
            searching for local chess clubs in your city (Yaoundé, Douala,
            Bafoussam, Garoua, etc.). Many communities coordinate via WhatsApp
            or Facebook groups.
          </p>
          <p className="mt-2 text-sm leading-6 text-zinc-700 dark:text-zinc-300">
            Tip: ask for “weekly meetups”, “rapid tournaments”, or “beginner
            sessions” to find events that match your level.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/50">
          ...
          <p className="mt-2 text-sm leading-6 text-zinc-700 dark:text-zinc-300">
            A lot of “chess cameroon” traffic is about discovering players and
            tracking ratings. On the homepage, you can look up any Chess.com
            username and see blitz/rapid ratings and recent activity.
          </p>
          <p className="mt-2 text-sm leading-6 text-zinc-700 dark:text-zinc-300">
            If you’re building a list of Cameroonian players, you can submit
            usernames there so they show up in the table.
          </p>
        </div>
      </section>
